    ...
    return (
        <Segment inverted>
            <Menu inverted secondary>
                ...
                />
                <Menu.Item 
                 as={Link} to={"/MatchDashboard"} content='Creation Match' 
                />
                {((user?.role == 3)&&(usersStore.isLoggedIn)) ? (
                    <Menu.Item icon="industry">
                        <Dropdown text='admin'>
                            <Dropdown.Menu>
                                <Dropdown.Item as={Link} to={"/MatchDashboard"} text='Creation Match' icon='world' />
                    ...
                    />)
                    :(<></>)}
                <Image width={100} centered src="./assets/pict/logo_293.jpg" circular={true} />
